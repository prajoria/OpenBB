"""Deprecated shim: openbb_pine.error_codes

Real implementation moved to :mod:`pyne_compiler.errors.codes` during the Pine extraction
...
_DEPRECATION_MSG = (
    "openbb_pine.error_codes is deprecated; import from pyne_compiler.errors.codes "
...
def __getattr__(name: str):
    try:
        ...
        raise AttributeError(
            f"module 'openbb_pine.error_codes' has no attribute {name!r}"
        ) from exc
