"""Deprecated shim: openbb_pine.compiler_errors

Real implementation moved to :mod:`pyne_compiler.errors.base` during the Pine extraction
...
_DEPRECATION_MSG = (
    "openbb_pine.compiler_errors is deprecated; import from pyne_compiler.errors.base "
...
def __getattr__(name: str):
    try:
        ...
        raise AttributeError(
            f"module 'openbb_pine.compiler_errors' has no attribute {name!r}"
        ) from exc
