"""Deprecated shim: openbb_pine.compiler.builtin_signatures

Real implementation moved to :mod:`pyne_compiler.compiler.builtin_signatures` during the Pine extraction
...
_DEPRECATION_MSG = (
    "openbb_pine.compiler.builtin_signatures is deprecated; import from pyne_compiler.compiler.builtin_signatures "
...
def __getattr__(name: str):
    try:
        ...
        raise AttributeError(
            f"module 'openbb_pine.compiler.builtin_signatures' has no attribute {name!r}"
        ) from exc
