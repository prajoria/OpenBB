"""Deprecated shim: openbb_pine.compiler.ir -> pyne_compiler.compiler.ir.

Real implementation lives at :mod:`pyne_compiler.compiler.ir` after the Pine
...
shim). Post-alias, ``openbb_pine.compiler.ir is pyne_compiler.compiler.ir`` — attribute reads,
...
_warnings.warn(
    "openbb_pine.compiler.ir is deprecated; import from pyne_compiler.compiler.ir instead. "
...
# ``import openbb_pine.compiler.ir`` returns the real module. Because Python
# is currently executing this file, ``sys.modules["openbb_pine.compiler.ir"]``
