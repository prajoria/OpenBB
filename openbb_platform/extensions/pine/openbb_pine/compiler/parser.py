"""Deprecated shim: openbb_pine.compiler.parser

Real implementation moved to :mod:`pyne_compiler.compiler.parser` during the Pine extraction
...
_DEPRECATION_MSG = (
    "openbb_pine.compiler.parser is deprecated; import from pyne_compiler.compiler.parser "
...
def __getattr__(name: str):
    try:
        ...
        raise AttributeError(
            f"module 'openbb_pine.compiler.parser' has no attribute {name!r}"
        ) from exc
