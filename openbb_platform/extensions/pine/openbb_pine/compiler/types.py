"""Deprecated shim: openbb_pine.compiler.types

Real implementation moved to :mod:`pyne_compiler.compiler.types` during the Pine extraction
...
_DEPRECATION_MSG = (
    "openbb_pine.compiler.types is deprecated; import from pyne_compiler.compiler.types "
...
def __getattr__(name: str):
    try:
        ...
        raise AttributeError(
            f"module 'openbb_pine.compiler.types' has no attribute {name!r}"
        ) from exc
