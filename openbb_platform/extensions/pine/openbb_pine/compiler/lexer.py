"""Deprecated shim: openbb_pine.compiler.lexer

Real implementation moved to :mod:`pyne_compiler.compiler.lexer` during the Pine extraction
...
_DEPRECATION_MSG = (
    "openbb_pine.compiler.lexer is deprecated; import from pyne_compiler.compiler.lexer "
...
def __getattr__(name: str):
    try:
        ...
        raise AttributeError(
            f"module 'openbb_pine.compiler.lexer' has no attribute {name!r}"
        ) from exc
