"""Deprecated shim: openbb_pine.compiler.codegen

Real implementation moved to :mod:`pyne_compiler.compiler.codegen` during the Pine extraction
...
_DEPRECATION_MSG = (
    "openbb_pine.compiler.codegen is deprecated; import from pyne_compiler.compiler.codegen "
...
def __getattr__(name: str):
    try:
        ...
        raise AttributeError(
            f"module 'openbb_pine.compiler.codegen' has no attribute {name!r}"
        ) from exc
