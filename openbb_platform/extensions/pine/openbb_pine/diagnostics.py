"""Deprecated shim: openbb_pine.diagnostics -> pyne_compiler.errors.diagnostics.

Real implementation lives at :mod:`pyne_compiler.errors.diagnostics` after the Pine
...
shim). Post-alias, ``openbb_pine.diagnostics is pyne_compiler.errors.diagnostics`` — attribute reads,
...
_warnings.warn(
    "openbb_pine.diagnostics is deprecated; import from pyne_compiler.errors.diagnostics instead. "
...
# ``import openbb_pine.diagnostics`` returns the real module. Because Python
# is currently executing this file, ``sys.modules["openbb_pine.diagnostics"]``
